...
//to avoid these, use try-catch blocks

try {
    fs.unlinkSync("file_to_remove.js"); 
    //"unlink" is reminiscent of the crash course computer science explanation on 
    //how computers delete files by simply specifying them as overwritable
} catch (error) {
    console.log(error);
}
