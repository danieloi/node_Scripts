...
function findItem(sku) {
    //remember you dont need parentheses around single arguments with arrow functions and with single line return statements, 'return' is unnecessary
...
function order(sku, quantity, complete) {
    ...
    if (isInStock(sku, quantity)) {
        ...
        console.log(`there aren't ${quantity} of item '${sku} in stock'`);
        return false;
    }
}
